  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('settings'.tr, style: AppTextStyles.title.copyWith(color: Colors.white)), // Dịch
      ),
      body: ListView(
        ...
        children: [
            ...
            child: GetX<AppController>(
              builder: (appController) => Column(
                children: [
                  ...
                  const Divider(),
                  ListTile(
                    title: Text('currency'.tr, style: AppTextStyles.body),
                    // Dịch
          ...
          Card(
            child: Column(
              children: [
                ListTile(
                  title: Text('contact_support'.tr, style: AppTextStyles.body),
                  // Dịch
                ...
                const Divider(),
                ListTile(
                  title: Text('terms_of_service'.tr, style: AppTextStyles.body),
                  // Dịch
                ...
                const Divider(),
                ListTile(
                  title: Text('privacy_policy'.tr, style: AppTextStyles.body),
                  // Dịch
